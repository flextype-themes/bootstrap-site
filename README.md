<h1 align="center">Bootstrap Site theme for <a href="https://flextype.org/">Flextype</a></h1>
...
The theme by itself is useful, but you may have an easier time getting up and running by installing a project skeleton for this theme, it is placed in the `_project`. The Bootstrap Site Project Skeleton contains: sample content, fieldsets for Admin Panel Plugin. Just copy `_project` content into your project folder.
